...
export default function LoginPage() {
  ...
  return (
    <div className="hb-root hb-login-wrap">
      <div className="hb-login-card">
        <h1 className="hb-login-title">Habla</h1>
        <p className="hb-login-tagline">
          {mode === "login"
        ...
        {notice && <div className="hb-form-error" style={{ background: "rgba(107,143,113,0.15)", borderColor: "#6b8f71", color: "#bfe0c4" }}>{notice}</div>}
        ...
        <form className="hb-form" onSubmit={handleSubmit}>
          ...
          />
          <button className="hb-primary-btn" type="submit" disabled={loading}>
            {loading
              ? "Un momento…"
              : mode === "login"
              ? "Iniciar sesión"
        ...
        <div className="hb-form-divider">o</div>
